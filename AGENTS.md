...
| `docs/` | 规划与架构；**v2** 见 `REQUIREMENTS_V2_0.md`、`BUSINESS_FLOW_V2_0.md`、`DEMO_V2_0.md` |
...
1. 先读 `docs/REQUIREMENTS_V2_0.md`（v2 重基线需求）、`docs/SOURCES_V2_0.md` 与 `docs/ARCHITECTURE.md` 再改代码。
